...
<div class="order">
    ...
    <!-- 添加收货地址 -->
    <div class="address">
      <mt-button class="dizhi" type="primary"><span>+</span>添加收货地址</mt-button>
    </div>
    <!-- delivery -->
    <div class="delivery">
      <div class="delivery-top">
        <span>送达时间</span>
          <span>
            <select name="" id="select" title="">
              <option value>尽快送达(17:17送达)</option>
            </select>
            <i class="iconfont">&#xe630;</i>
          </span>
        </div>
    ...
    <div class="infos">
      <div class="info-box">
          <div class="info-name">
            <span>吉野家</span>
            <span class="dian">(北京站店)</span>
          </div>
          <ul>
            <li class="jiwei">
              <img src="https://fuss10.elemecdn.com/0/cf/e339711eecd730be5d3bf020f383epng.png?imageMogr/format/webp/thumbnail/!72x72r/gravity/Center/crop/72x72/" alt="">
              <p>吉味双拼饭</p>
              <span>x1</span>
              <span><span>￥</span>36.5</span>
            </li>
            <li>
              <div>
                <span class="baoz">包装</span>
                <span>餐盒</span>
              </div>
              <span>￥1</span>
            </li>
          ...
          <div class="hongb">
            ...
            <span style="line-height:.55rem">选择地之后使用红包</span>
          </div>
          <div class="shuom">
            <div>
              <span class="shuoming">优惠说明</span>
              <i class="iconfont">&#xe674;</i>
            </div>
            <div>
              <span>小计 ￥</span>
              <span class="prc">44.5</span>
            </div>
          </div>
        </div>
    </div>
    ...
    <div class="beizhu">
      <span>订单备注</span>
        <span>
          <select name="" id="select" title="">
            <option value>口味偏好、餐具份数等</option>
          </select>
          <i class="iconfont">&#xe630;</i>
        </span> 
    </div>
    ...
    <div class="zhifu2">
      <div class="yiyh">
        ...
        <span>19.18</span>
        <span>|</span>
        <span>已优惠￥<span>18</span></span>
      </div>
      <div class="gozhifu">去支付</div>
    </div>
</div>
</template>
...
header{font-size:.16rem;height:.44rem}
/* 添加收货地址 */
.address{
  height: .83rem;
...
.delivery {
  ...
  height: 1.04rem;
  font-size: .16rem;
  box-shadow: 0 0 0.2rem 0 rgba(0,0,0,.08);
...
.delivery-bottom span, .delivery-top span {
  display: flex;
  align-items: center;
}
.zhifu{
